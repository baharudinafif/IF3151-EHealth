		...
		<?php
			...
			echo '<div id="listpesand">
				...
				<div id="image_icon1" > 
					...
					<span id="tab3"> &nbsp; &nbsp; &nbsp; &nbsp;  (Jawab) Konsultasi: Flu Berkelanjutan  </span> 
				</div> 
				</a>
				</form>
			...
			<div id="image_icon5"> 
				...
				<span id="tab3"> (Jawab) Konsultasi: Gatal-Gatal, Disebabkan ...  </span> 
			</div>
			</a>
			</form>
			...
			echo '<div id="listpesand">
						...
						<div id="image_icon3">
							...
							<span id="tab3"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; (Jawab) Konsultasi: Batuk Berdahak  </span> 
						</div>
						</a>
						</form>
			...
			echo '<div id="listpesand">
						...
						<div id="image_icon4"> 
							...
							<span id="tab3"> &nbsp; &nbsp;  (Jawab) Konsultasi: Mata Berair Seitap Malam  </span> 
